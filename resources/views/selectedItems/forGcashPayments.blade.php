...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center mb-4">
            <h4 style="margin: auto 0;"><span class="badge bg-label-danger me-1">Gcash Payment</h4>
            <form action="{{ route('selectedItems.forGcashPayments') }}" method="GET" class="d-flex">
                ...
                <tbody class="table-border-bottom-0" id="tableBody">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="bi bi-receipt me-1 details-button text-success" href="#" data-bs-toggle="modal" data-bs-target="#paymentProof{{ $referenceNo }}" data-user-id="{{ $referenceNo }}"></a>
