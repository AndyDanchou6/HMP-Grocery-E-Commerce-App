            ...
            <div class="modal-body">
                ...
                <div class="row item-row" data-item-id="{{ $item->id }}">
                    ...
                    <div class="col-sm-4 mb-3">
                        ...
                        <span><input type="text" class="form-control item-sub-total" data-item-id="{{ $user['referenceNo'].'_'.$item->id }}" value="₱{{ number_format($item->quantity * $item->price, 2) }}" readonly></span>
                    </div>
                    <div class="col-sm-12">
                        <hr>
                    </div>
                ...
                <div class="modal-footer">
                    <div class="row row-cols-1 row-cols-md-2 align-items-center mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="{{ \Carbon\Carbon::parse($user['items'][0]->created_at)->timezone('Asia/Manila')->format('l, F j, Y') }}" readonly>
                        </div>
                    </div>
